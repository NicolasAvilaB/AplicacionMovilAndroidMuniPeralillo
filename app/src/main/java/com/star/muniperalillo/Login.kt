...
class Login : AppCompatActivity(), DialogoConfirmacion.FinalizoCuadroDialogo {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val charactersForbiden = "!ćĆΔΔΔ∆δ₲₡✓ÇÉüæéęĘąǍǎČčĎďĚěǦǧȞȟǏǐ̌ǰǨǩĽľŇňǑǒŘřŠšṦṧŤťǓǔǙǚŽžǮǯĄłŁżŻĖńŃČčėÆâôäöàòåûçùêÿëÖèÜï¢î£ì¥Ä₧Åƒá░í▒ó▓ú│┤╡ª╢º╖¿╕⌐╣¬║½╗¼╝¡╜«╛»┐ └┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ËÌÍÎÏÐÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðòóôõö÷øùúûüýþÿ¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅĒēĀāǢǣĪīŌōŪūǕǖȲȳÆÇÈÉÊ’“”•–—˜™š›œžŸ¡¢£¤¥¦§¨©ª«¬®{|}~Δ€‚ƒ„…†‡ˆ‰Š‹ŒŽ‘[\\]^_`=>?@:;<\"#$%&'()*+,-./"
        ...
        clave.setFilters(arrayOf(LengthFilter(30), filtro_clave))
        pedir_telefono()
