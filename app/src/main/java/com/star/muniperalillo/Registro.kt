...
class Registro : AppCompatActivity(), DialogoConfirmacion.FinalizoCuadroDialogo {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val charactersForbiden2 = " !ΔΔ∆Δδ₲₡✓ÇüæęĘąǍǎČčĎďĚěǦǧȞȟǏǐ̌ǰǨǩĽľŇňǑǒŘřŠšṦṧŤťǓǔǙǚŽžǮǯĄłŁżŻĖČčėÆâôäöàòåûçùêÿëÖèÜï¢î£ì¥Ä₧Åƒ░▒▓│┤╡ª╢º╖¿╕⌐╣¬║½╗¼╝¡╜«╛»┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ËÌÎÏÐÒÔÕÖ×ØÙÛÜÞßàâãäåæçèêëìîïðòôõö÷øùûüþÿ¯°±²³´µ¶·¸¹º»¼½¾¿ÀÂÃÄÅĒēĀāǢǣĪīŌōŪūǕǖȲȳÆÇÈÊ’“”•–—˜™š›œžŸ¡¢£¤¥¦§¨©ª«¬®{|}~Δ€‚ƒ„…†‡ˆ‰Š‹ŒŽ‘[\\]^`=>?@:;<\"#$%&'()*+,/"
        ...
        val charactersForbiden55 = "0123456789!ΔΔ∆Δδ₲₡✓ÇüæęĘąǍǎČčĎďĚěǦǧȞȟǏǐǰǨǩĽľŇňǑǒŘřŠšṦṧŤťǓǔǙǚŽžǮǯĄłŁżŻĖČčėÆâôäöàòåûçùêÿëÖèÜï¢î£ì¥Ä₧Åƒ░▒▓│┤╡ª╢º╖¿╕⌐╣¬║½╗¼╝¡╜«╛»┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ËÌÎÏÐÒÔÕÖ×ØÙÛÜÞßàâãäåæçèêëìîïðòôõö÷øùûüþÿ¯°±²³´µ¶·¸¹º»¼½¾¿ÀÂÃÄÅĒēĀāǢǣĪīŌōŪūǕǖȲȳÆÇÈÊ’“”•–—˜™š›œžŸ¡¢£¤¥¦§¨©ª«¬®{|}~Δ€‚ƒ„…†‡ˆ‰Š‹ŒŽ‘[\\]^`=>?@:;<\"#$%&'()*+,-._/"
        ...
        rut1.setFilters(arrayOf(LengthFilter(12), AllCaps(), filtro_rut))
        nombre1.setFilters(arrayOf(LengthFilter(70), filtro_nombre))
        clave1.setFilters(arrayOf(LengthFilter(30), filtro_clave))
        nombre_completo.setFilters(arrayOf(LengthFilter(70), filtro_nombre_completo))
        direccion1.setFilters(arrayOf(LengthFilter(80), filtro_direccion))
        telefono1.setFilters(arrayOf(LengthFilter(8), filtro_telefono))
        correo1.setFilters(arrayOf(LengthFilter(60), filtro_correo))
        mes1.setFilters(arrayOf(LengthFilter(2), filtro_mes))
        ...
        mes1.addTextChangedListener(object: TextWatcher{
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (mes12 != null) {
                    ...
                    when(mes12){
                        1 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Enero").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        2 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Febrero").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        3 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Marzo").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        4 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Abril").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        5 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Mayo").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        6 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Junio").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        7 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Julio").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        8 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Agosto").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        9 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Septiembre").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        10 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Octubre").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        11 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Noviembre").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                        12 -> ViewTooltip.on(this@Registro, mes1).autoHide(true, 3000).corner(30).position(ViewTooltip.Position.TOP).text("Diciembre").clickToHide(true).textColor(Color.WHITE).color(Color.DKGRAY).arrowHeight(15).arrowWidth(15).distanceWithView(0).textSize(1, 20.0F).show()
                    }
                }
            }
            override fun afterTextChanged(s: Editable?) {}
    ...
    fun pedir_telefono() {
        when { ActivityCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED -> ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.CALL_PHONE), REQUEST_ACCESS_FINE)
        }
    }
